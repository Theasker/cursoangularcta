...
var ProductService = (function () {
    ...
    ProductService.prototype.getProducts = function () {
        return this.http.get(this.baseUrl)
            ...
            .do(function (data) { console.log('data: ', data); })
    ...
    ProductService.prototype.createProduct = function (product, options) {
        ...
        return this.http.post(this.baseUrl, product, options)
            .map(this.extractData)
            .do(function (data) { console.log('data: ', JSON.stringify(data)); })
            .catch(this.handleError);
    };
    ProductService.prototype.updateProduct = function (product, options) {
        ...
        return this.http.put(url, product, options) // No devuelve nada 'put'
            .map(function () { return product; }) // Queremos devolver el producto actualizado
            .catch(this.handleError);
    };
