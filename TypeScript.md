...
- [TypeScript](#typescript)
    ...
    - [Variables y tipos de variables](#variables-y-tipos-de-variables)
        - [Declaración de variables](#declaración-de-variables)
            - [Diferencias entre var y let (ES2015)](#diferencias-entre-var-y-let-es2015)
        - [Estructuras básicas](#estructuras-básicas)
        - [Tipos de variables](#tipos-de-variables)
            - [Inferencia de tipos](#inferencia-de-tipos)
    - [Tipos en Typescript](#tipos-en-typescript)
        - [Booleans](#booleans)
        - [Strings](#strings)
        - [Number](#number)
        - [Array](#array)
    ...
    - [Clases en Typescript](#clases-en-typescript)
        - [Herencia, propiedades y constructor](#herencia-propiedades-y-constructor)
    - [Interfaces en Typescript](#interfaces-en-typescript)
        - [Definir una interfaz](#definir-una-interfaz)
        - [Implementar múltiples interfaces](#implementar-múltiples-interfaces)
    - [Clases abstractas](#clases-abstractas)
    - [Módulos en Typescript](#módulos-en-typescript)
        - [Definir un módulo](#definir-un-módulo)
        - [Módulo con clases y funciones](#módulo-con-clases-y-funciones)
    - [Funciones en Typescript](#funciones-en-typescript)
        - [Definir una función con parámetros](#definir-una-función-con-parámetros)
        - [Funciones con parámetros opcionales](#funciones-con-parámetros-opcionales)
        - [El operador Spread o Rest (ecmascript6)](#el-operador-spread-o-rest-ecmascript6)
    - [Expresiones lambda en Typescript](#expresiones-lambda-en-typescript)
        - [Ejemplo sin expresión lambda](#ejemplo-sin-expresión-lambda)
        - [Ejemplo con expresiones lambda](#ejemplo-con-expresiones-lambda)
    - [Tipos genéricos en Typescript](#tipos-genéricos-en-typescript)
        - [Tipos genéricos en clases](#tipos-genéricos-en-clases)
    - [Unir componentes en Typescript (Merging)](#unir-componentes-en-typescript-merging)
        - [Merging con módulos](#merging-con-módulos)
        - [Merging módulos con enums](#merging-módulos-con-enums)
    - [enlaces](#enlaces)
...
#### Diferencias entre var y let (ES2015)
...
En una variable que no se le ha asignado el tipo de variable se le asigna un valor, TypeScript infiere el tipo de la variable, es decir, según el dato que se le asigna, le asigna (infiere) un tipo respecto a ese valor.
...
Clases que no se pueden instanciar y que tienen como mínimo un método abstracto que no tiene implementación.

Para acceder a los métodos `private` desde la clase heredada, hay que acceder por la palabra reservadada `super`.
...
### El operador Spread o Rest (ecmascript6)
